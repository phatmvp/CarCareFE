...
import { fetchBookings, updateBooking, fetchServiceByName, createBill, fetchAllServices } from "../../apis";
...
const BookingPage = () => {
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      const updatedBooking = await updateBooking(selectedBooking, {
        status: "Cancelled",
        cancelReason,
      });
      setBookings((prev) => prev.map((b) => (b._id === selectedBooking ? updatedBooking : b)));
