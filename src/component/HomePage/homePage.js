...
const HomePage = () => {
  ...
  const imgCare = "https://thanhphongauto.com/wp-content/uploads/2020/04/Lamborghini.jpg"; // Car garage background image
    ...
    <Box sx={{ backgroundColor: "#f5f5f7" }}>
      ...
      >
        ...
        >
          <Container>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              ...
              >
                {["Trang Chủ", "Dịch Vụ", "Đối Tác Gara", "Đánh Giá", "Liên Hệ"].map((item) => (
                  <Typography
                    key={item}
                    component="a"
                    href="#"
        ...
        >
          <Container maxWidth="md" sx={{ textAlign: "center" }}>
            ...
            >
              Kết nối với hơn 500+ gara uy tín trên toàn quốc. Đặt lịch nhanh chóng, theo dõi quá trình bảo dưỡng, và tận hưởng trải nghiệm chăm sóc xe chuyên nghiệp.
            </Typography>
            <Stack
      ...
      <Box sx={{ py: 10, backgroundColor: "#fff" }}>
        <Container>
          ...
          >
            AutoBook kết nối bạn với các dịch vụ chăm sóc xe chất lượng cao từ những gara uy tín nhất
          </Typography>
      ...
      <Box sx={{ py: 10, backgroundColor: "#f5f5f7" }}>
        <Container>
          ...
          >
            Chỉ với 3 bước đơn giản, xe của bạn sẽ được chăm sóc bởi những chuyên gia hàng đầu
          </Typography>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="body2" sx={{ color: "#D1D5DB", mb: 3 }}>
                Nền tảng đặt lịch chăm sóc xe hàng đầu, kết nối khách hàng với các gara uy tín trên toàn quốc.
              </Typography>
              <Stack direction="row" spacing={2}>
                <IconButton sx={{ color: accentColor, "&:hover": { color: "#E6C774" } }}>
                  <FaTwitter />
                </IconButton>
                <IconButton sx={{ color: accentColor, "&:hover": { color: "#E6C774" } }}>
                  <FaFacebook />
            ...
            <Grid item xs={12} sm={6} md={2}>
              ...
              <Stack spacing={1}>
                {["Bảo dưỡng định kỳ", "Sửa chữa & Bảo hành", "Chăm sóc xe", "Phụ tùng chính hãng"].map(
                  (item) => (
                    <Typography
                      key={item}
                      component="a"
            ...
            <Grid item xs={12} sm={6} md={2}>
              ...
              <Stack spacing={1}>
                {["Về chúng tôi", "Đối tác gara", "Blog", "Liên hệ", "Tuyển dụng"].map(
                  (item) => (
                    <Typography
                      key={item}
                      component="a"
