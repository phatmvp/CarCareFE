    ...
    <Container maxWidth="lg" sx={{ my: 4 }}>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                  <Rating
                    ...
                    emptyIcon={
                      <Star fontSize="large" sx={{ color: "grey.300" }} />
                    }
                  />
                ...
                <Button
                  ...
                  color="secondary"
                  size="large"
                  sx={{ mt: 1, fontWeight: "bold", width: "100%" }}
                >
                  Đặt lịch ngay
                </Button>
              </Paper>
      ...
      <Box sx={{ width: "100%", mb: 4 }}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          ...
          >
            <Tab icon={<Info />} label="Thông tin" id="garage-tab-0" />
            <Tab icon={<Build />} label="Dịch vụ" id="garage-tab-1" />
            <Tab icon={<DirectionsCar />} label="Hình ảnh" id="garage-tab-2" />
            <Tab icon={<Comment />} label="Đánh giá" id="garage-tab-3" />
          </Tabs>
        </Box>
